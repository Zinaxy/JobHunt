...
const CreateJobForm = () => {
    ...
    const selectClass =
        "appearance-none block w-full bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-600 rounded py-3 px-4 mb-3 leading-tight focus:outline-none";
    return (
        <form className="w-full p-8 text-start">
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="w-full md:w-1/2 px-3">
                    <label className={labelClass} htmlFor="grid-last-name">
                        Your Email
                    </label>
                    <input
                        className={myClasses}
            ...
            <div className="flex flex-wrap -mx-3 mb-6">
                ...
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label className={labelClass} htmlFor="grid-state">
                        Industry
                    </label>
                    <div className="relative">
                        <select className={selectClass} id="grid-state">
                ...
                <div className="w-full md:w-1/2 px-3">
                    <label
                        for="uploadFile1"
                        class="bg-orange-600 hover:bg-gray-700 text-white text-sm px-4 py-2.5 my-5 outline-none rounded w-max cursor-pointer mx-auto block font-[sans-serif]"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex flex-wrap -mx-3 mb-2">
                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    <label className={labelClass} htmlFor="grid-city">
                        Job Title
                    </label>
                    <input
                        className={myClasses}
                ...
                <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
                    <label className={labelClass} htmlFor="grid-zip">
                        Salary Range
                    </label>
                    <input
                        className={myClasses}
